...
* @param alternateReadingTokens Any [[GroupedToken]]s belonging to this token as alternate readings.
...
case class GroupedToken (
  ...
  alternateReadingTokens: Vector[GroupedToken] = Vector.empty[GroupedToken],
